...
/**
 * This is the item provider adapter for a {@link mtbe.fr.trace.Trace} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class TraceItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Trace_sourceModel_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Trace_sourceModel_feature", "_UI_Trace_type"),
				 TracePackage.Literals.TRACE__SOURCE_MODEL,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addTargetModelPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Trace_targetModel_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Trace_targetModel_feature", "_UI_Trace_type"),
				 TracePackage.Literals.TRACE__TARGET_MODEL,
				 true,
				 false,
				 true,
				 null,
	...
	public Collection getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(TracePackage.Literals.TRACE__TRACES);
		}
	...
	protected void collectNewChildDescriptors(Collection newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(TracePackage.Literals.TRACE__TRACES,
