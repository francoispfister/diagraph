...
/**
 * This is the item provider adapter for a {@link org.isoe.diagraph.diagraph.DSimpleEdge} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class DSimpleEdgeItemProvider extends DEdgeItemProvider {
	/**
	 ...
	 * @generated
	 */
	public DSimpleEdgeItemProvider(AdapterFactory adapterFactory) {
	...
	public String getText(Object object) {
		String label = ((DSimpleEdge)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_DSimpleEdge_type") :
			getString("_UI_DSimpleEdge_type") + " " + label;
	}
