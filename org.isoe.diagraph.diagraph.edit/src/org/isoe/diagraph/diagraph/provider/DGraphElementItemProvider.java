...
/**
 * This is the item provider adapter for a {@link org.isoe.diagraph.diagraph.DGraphElement} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class DGraphElementItemProvider 
	 ...
	 * @generated
	 */
	public DGraphElementItemProvider(AdapterFactory adapterFactory) {
	...
	public String getText(Object object) {
		String label = ((DGraphElement)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_DGraphElement_type") :
			getString("_UI_DGraphElement_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(DGraphElement.class)) {
