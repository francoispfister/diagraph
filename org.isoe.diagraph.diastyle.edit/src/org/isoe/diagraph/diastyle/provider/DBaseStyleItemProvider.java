...
/**
 * This is the item provider adapter for a {@link org.isoe.diagraph.diastyle.DBaseStyle} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class DBaseStyleItemProvider
	 ...
	 * @generated
	 */
	public DBaseStyleItemProvider(AdapterFactory adapterFactory) {
	...
	public String getText(Object object) {
		String label = ((DBaseStyle)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_DBaseStyle_type") :
			getString("_UI_DBaseStyle_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(DBaseStyle.class)) {
