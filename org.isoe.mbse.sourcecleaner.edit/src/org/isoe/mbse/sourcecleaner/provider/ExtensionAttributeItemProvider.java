...
/**
 * This is the item provider adapter for a {@link org.isoe.mbse.sourcecleaner.ExtensionAttribute} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ExtensionAttributeItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ExtensionAttribute_name_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ExtensionAttribute_name_feature", "_UI_ExtensionAttribute_type"),
				 SourcecleanerPackage.Literals.EXTENSION_ATTRIBUTE__NAME,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 SourcecleanerPackage.Literals.EXTENSION_ATTRIBUTE__VALUE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public String getText(Object object) {
		...
		return label == null || label.length() == 0 ?
			getString("_UI_ExtensionAttribute_type") :
			getString("_UI_ExtensionAttribute_type") + " " + label;
	}
