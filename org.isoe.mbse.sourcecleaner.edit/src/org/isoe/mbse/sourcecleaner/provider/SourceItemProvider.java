...
/**
 * This is the item provider adapter for a {@link org.isoe.mbse.sourcecleaner.Source} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class SourceItemProvider
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addHandledPropertyDescriptor(object);
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 SourcecleanerPackage.Literals.SOURCE__COMMENT,
				 true,
				 false,
				 false,
	...
	/**
	 * This adds a property descriptor for the Handled feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addHandledPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Source_handled_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Source_handled_feature", "_UI_Source_type"),
				 SourcecleanerPackage.Literals.SOURCE__HANDLED,
				 true,
				 false,
				 false,
	...
	protected void addMarkPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Source_mark_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Source_mark_feature", "_UI_Source_type"),
				 SourcecleanerPackage.Literals.SOURCE__MARK,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.BOOLEAN_VALUE_IMAGE,
	...
	protected void addContentPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Source_content_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Source_content_feature", "_UI_Source_type"),
				 SourcecleanerPackage.Literals.SOURCE__CONTENT,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
