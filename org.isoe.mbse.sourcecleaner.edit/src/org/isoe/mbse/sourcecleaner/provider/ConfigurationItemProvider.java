...
/**
 * This is the item provider adapter for a {@link org.isoe.mbse.sourcecleaner.Configuration} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ConfigurationItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 SourcecleanerPackage.Literals.CONFIGURATION__LOCATION,
				 true,
				 false,
				 false,
	...
	protected void addTempPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Configuration_temp_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Configuration_temp_feature", "_UI_Configuration_type"),
				 SourcecleanerPackage.Literals.CONFIGURATION__TEMP,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(SourcecleanerPackage.Literals.CONFIGURATION__PROJECTS);
		}
	...
	public String getText(Object object) {
		String label = ((Configuration)object).getLocation();
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(SourcecleanerPackage.Literals.CONFIGURATION__PROJECTS,
				 SourcecleanerFactory.eINSTANCE.createProject()));
	}
