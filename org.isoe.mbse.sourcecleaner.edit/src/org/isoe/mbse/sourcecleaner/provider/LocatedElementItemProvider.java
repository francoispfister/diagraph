...
/**
 * This is the item provider adapter for a {@link org.isoe.mbse.sourcecleaner.LocatedElement} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_LocatedElement_absolutePath_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_LocatedElement_absolutePath_feature", "_UI_LocatedElement_type"),
				 SourcecleanerPackage.Literals.LOCATED_ELEMENT__ABSOLUTE_PATH,
				 true,
				 false,
				 false,
	...
	protected void addNamePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_LocatedElement_name_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_LocatedElement_name_feature", "_UI_LocatedElement_type"),
				 SourcecleanerPackage.Literals.LOCATED_ELEMENT__NAME,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
