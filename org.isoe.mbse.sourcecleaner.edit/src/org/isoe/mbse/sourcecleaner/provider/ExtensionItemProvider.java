...
/**
 * This is the item provider adapter for a {@link org.isoe.mbse.sourcecleaner.Extension} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ExtensionItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 SourcecleanerPackage.Literals.EXTENSION__EXTENSION_POINT,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addClazzPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Extension_clazz_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Extension_clazz_feature", "_UI_Extension_type"),
				 SourcecleanerPackage.Literals.EXTENSION__CLAZZ,
				 true,
				 false,
				 false,
	...
	protected void addPointIdPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Extension_pointId_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Extension_pointId_feature", "_UI_Extension_type"),
				 SourcecleanerPackage.Literals.EXTENSION__POINT_ID,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addExtraPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Extension_extra_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Extension_extra_feature", "_UI_Extension_type"),
				 SourcecleanerPackage.Literals.EXTENSION__EXTRA,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addImplementsPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Extension_implements_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Extension_implements_feature", "_UI_Extension_type"),
				 SourcecleanerPackage.Literals.EXTENSION__IMPLEMENTS,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addDiagraphPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Extension_diagraph_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Extension_diagraph_feature", "_UI_Extension_type"),
				 SourcecleanerPackage.Literals.EXTENSION__DIAGRAPH,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 SourcecleanerPackage.Literals.EXTENSION__ID,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 SourcecleanerPackage.Literals.EXTENSION__NAME,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(SourcecleanerPackage.Literals.EXTENSION__ATTRIBUTES);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(SourcecleanerPackage.Literals.EXTENSION__ATTRIBUTES,
				 SourcecleanerFactory.eINSTANCE.createExtensionAttribute()));
	}
