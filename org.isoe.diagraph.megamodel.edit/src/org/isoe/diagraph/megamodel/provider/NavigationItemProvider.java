...
/**
 * This is the item provider adapter for a {@link org.isoe.diagraph.megamodel.Navigation} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class NavigationItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 MegamodelPackage.Literals.NAVIGATION__FROM,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 MegamodelPackage.Literals.NAVIGATION__TO,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addIdPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Navigation_id_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Navigation_id_feature", "_UI_Navigation_type"),
				 MegamodelPackage.Literals.NAVIGATION__ID,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		String label = ((Navigation)object).getId();
	...
	public ResourceLocator getResourceLocator() {
		return MegamodelEditPlugin.INSTANCE;
	}
