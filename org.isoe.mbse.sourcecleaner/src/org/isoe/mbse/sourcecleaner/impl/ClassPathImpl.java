 ...
 * </p>
 * <ul>
 *   <li>{@link org.isoe.mbse.sourcecleaner.impl.ClassPathImpl#getName <em>Name</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ClassPathImpl extends EObjectImpl implements ClassPath {
	...
	protected EClass eStaticClass() {
		return SourcecleanerPackage.Literals.CLASS_PATH;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SourcecleanerPackage.CLASS_PATH__NAME, oldName, name));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case SourcecleanerPackage.CLASS_PATH__NAME:
				return getName();
		}
