...
public final class Messages extends NLS {
	private static final String BUNDLE_NAME = "org.eclipse.gmt.mod.infra.common.core.internal.messages"; //$NON-NLS-1$
	public static String StringUtils_ellipsis;

	public static String AbstractMoDCatalog_brokenRef;
	public static String AbstractMoDCatalog_nameConflict;
	public static String AbstractMoDCatalog_oneRootOnly;
	public static String AbstractMoDCatalog_waitingCatalogJobName;
	public static String AbstractMoDCatalog_wrontKindOfRoot;
